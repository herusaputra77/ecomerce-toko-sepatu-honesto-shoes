            ...
            <div class="row m-b-n50">
                <div class="col-12 col-lg-6 m-b-50 order-2 order-lg-1" data-aos="fade-up" data-aos-duration="1000">
                    ...
                    <div class="contact-title p-b-15">
                        <h2 class="title">Upload Bukti Pembayaran</h2>
                    </div>
                    <!-- Section Title End -->
                                ...
                                <div class="col-12">
                                    <div class="row">
                                        <div class="col-md-12 mb-3">
                                            <h5>Total Bayar: Rp <p>{{ number_format($order->total_bayar, 0, ',', '.') }}</p>
                                            </h5>
                                        ...
                                        <div class="col-12">
                                            <button type="submit" class="btn btn-primary btn-hover-dark">Kirim Bukti
                                                Pembayaran</button>
                                        </div>
                    ...
                    @else
                        <div class="about-thumb">
                            <img class="fit-image" width="50px"
                                src="{{ asset('gambar/bukti_bayar/' . $order->bukti_bayar) }}">
                        </div>
                    @endif
                    <!-- Section Title End -->
