            ...
            <div class="row">
                <div class="col-12 text-center">
                    <div class="breadcrumb-wrapper">
                        <h2 class="breadcrumb-title">Terima Barang</h2>
                        <ul>
                            <li><a href="/">Home</a></li>
                            <li>Terima Barang</li>
                        </ul>
            ...
            <div class="row m-b-n50">
                <div class="col-12 col-lg-6 m-b-50 order-2 order-lg-1" data-aos="fade-up" data-aos-duration="1000">
                    ...
                    <div class="contact-title p-b-15">
                        <h2 class="title">Upload Bukti Penerimaan Barang</h2>
                    </div>
                    <!-- Section Title End -->

                    <!-- Contact Form Wrapper Start -->
                    <div class="contact-form-wrapper contact-form">
                        <form action="/update-terima-order" method="post" enctype="multipart/form-data">
                            @csrf
                                ...
                                <div class="col-12">
                                    <div class="row">
                                        {{-- <div class="col-md-12 mb-3">
                                            <h5>No Rekening BRI: <p>4524-4523-7585</p>
                                            </h5>
                ...
                <div class="col-12 col-lg-6 m-b-50 order-1 order-lg-2" data-aos="fade-up" data-aos-duration="1500">
                    <!-- Section Title Start -->
                    <div class="contact-title p-b-15">
                        <h2 class="title">Detail Bukti Penerimaan Barang</h2>
                    </div>
                    ...
                    @else
                        <div class="about-thumb">
                            <img class="fit-image" width="50px"
                                src="{{ asset('gambar/bukti_terima/' . $order->bukti_terima) }}">
                        </div>
                    @endif
                    <!-- Section Title End -->
